...
def create_lst_boys(boys_one, girls_one, boys_one_plus, girls_one_plus, boys_two, girls_two, boys_two_plus, girls_two_plus, boys_three, girls_three, boys_three_plus, girls_three_plus, boys, girls):
    ...
    for row in range(len(girls) + len(boys)):
        if len(desk_4) < 6:
            try:
                boy = random.choice(boys)
                desk_4.append(boy)
